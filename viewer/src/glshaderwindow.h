...
private:
    ...
    // Skeleton
    trimesh::point *sk_vertices;
    trimesh::vec *sk_normals;
    trimesh::vec2 *sk_texcoords;
    trimesh::point *sk_colors;
    int *sk_indices;
    int sk_numPoints;
    int sk_numIndices;
    ...
    QOpenGLShaderProgram *skel_program;
    ...
    // *********** Skeleton
    QOpenGLVertexArrayObject skel_vao;
    QOpenGLBuffer skel_vertexBuffer;
    QOpenGLBuffer skel_indexBuffer;
    QOpenGLBuffer skel_normalBuffer;
    QOpenGLBuffer skel_colorBuffer;
    QOpenGLBuffer skel_texcoordBuffer;
    Joint *rootNode = NULL;
